...
### 5. 產後健康照護服務計算機
依服務日期及生產日期計算產後天數，協助判斷建議填報的產後健康照護服務項目。

* 依日曆月份判斷並顯示建議填報的 5P 或 5Q，以及健保卡就醫序號 IC5P 或 IC5Q。
* 正確處理月底與閏年日期，例如 1 月 31 日加 1 個月會調整為 2 月最後一天。
* 清楚提醒服務日期是否早於生產日期，或已超過產後 3 個月的服務時程。
* 所有日期運算均在瀏覽器本機完成，不會上傳病人資料。
